...
export function getAnthropicApiKeyWithSource(
  ...
  // Allow any ANTHROPIC_API_KEY when using third-party providers (OpenRouter, OpenCode, etc.)
  // This bypasses the approved list requirement since these providers don't need Anthropic OAuth
